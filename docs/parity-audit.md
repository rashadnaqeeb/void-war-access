...
the slider mirror's reserved large flag; Rashad set the keyboard
granularity to 0.01 per arrow step and 0.1 per large step - the game's
wheel coarseness, 0.05, is not what the mirror preserves, its effect path
is). Ctrl+Up/Down stay
